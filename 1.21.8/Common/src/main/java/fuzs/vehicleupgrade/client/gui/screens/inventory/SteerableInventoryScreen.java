...
public class SteerableInventoryScreen extends AbstractContainerScreen<SteerableInventoryMenu> {
    ...
    public SteerableInventoryScreen(SteerableInventoryMenu menu, Inventory inventory, Component component) {
